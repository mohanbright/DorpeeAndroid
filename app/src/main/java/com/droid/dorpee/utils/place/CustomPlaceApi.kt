 ...
 */
class CustomPlaceApi private constructor(
...
//        val globalPlusCode = plusCode.getString(GLOBAL_CODE)
    ...
    companion object {
        private val TAG = CustomPlaceApi::class.java.simpleName
    ...
    data class Builder(
        ...
        fun setContary(sessionToken: String) = apply { this.sessionToken = sessionToken }

        /**
         * Builds and creates an object of the PlaceAPI
         */
        fun build(context: Context) = CustomPlaceApi(apiKey, sessionToken, context)
    }
}
