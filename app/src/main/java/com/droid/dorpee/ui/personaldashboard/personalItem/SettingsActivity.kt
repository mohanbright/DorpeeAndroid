...
import com.droid.dorpee.databinding.ActivitySettingsBinding
...
import com.droid.dorpee.ui.personaldashboard.fragments.PaymentFragment
    ...
    override fun initListeners() {
        binding.tabLayout.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
            ...
            override fun onTabSelected(tab: TabLayout.Tab?) {
                when (tab?.position) {
                    0 -> loadFragment(PrivacyFragment())
                    1 -> loadFragment(PaymentFragment())
                    else -> loadFragment(PrivacyFragment())
                }
