...
public final class ActivitySearchPrefrencesBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySearchPrefrencesBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull RecyclerView recyclerViewSearch, @NonNull TextView textView13) {
  ...
  @NonNull
  public static ActivitySearchPrefrencesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySearchPrefrencesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_search_prefrences, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySearchPrefrencesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RecyclerView recyclerViewSearch = rootView.findViewById(id);
      ...
      return new ActivitySearchPrefrencesBinding((ConstraintLayout) rootView, alertView, backbtn,
          guideline15, guideline16, guideline17, imageViewProfilePic, recyclerViewSearch,
          textView13);
    }
