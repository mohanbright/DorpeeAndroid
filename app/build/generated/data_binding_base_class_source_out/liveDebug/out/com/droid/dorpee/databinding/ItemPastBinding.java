...
public final class ItemPastBinding implements ViewBinding {
  @NonNull
  ...
  private ItemPastBinding(@NonNull MaterialCardView rootView, @NonNull TextView bookedForTV,
      @NonNull Button buttonStay, @NonNull ImageView imageVieId, @NonNull ImageView imageView14,
      @NonNull ImageView mapIV, @NonNull TextView nameTV, @NonNull RelativeLayout relative,
      @NonNull TextView textView30, @NonNull TextView textViewdate, @NonNull TextView tvAddress,
      @NonNull TextView usedCreditesTV, @NonNull TextView venue) {
  ...
  @NonNull
  public static ItemPastBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemPastBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_past, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemPastBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPastBinding((MaterialCardView) rootView, bookedForTV, buttonStay, imageVieId,
          imageView14, mapIV, nameTV, relative, textView30, textViewdate, tvAddress, usedCreditesTV,
          venue);
    }
