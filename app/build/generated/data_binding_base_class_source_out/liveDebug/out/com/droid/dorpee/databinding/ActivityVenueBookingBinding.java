...
public final class ActivityVenueBookingBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityVenueBookingBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityVenueBookingBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityVenueBookingBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_venue_booking, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityVenueBookingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityVenueBookingBinding((ConstraintLayout) rootView, alertView, backbtn,
          container, guideline15, guideline16, guideline17, imageViewProfilePic, loginLoader,
          tabLayout, textView13);
    }
