...
public final class ItemVenueTodayBinding implements ViewBinding {
  @NonNull
  ...
  private ItemVenueTodayBinding(@NonNull MaterialCardView rootView, @NonNull TextView bookedForTV,
      @NonNull Button buttonCheckin, @NonNull Button buttonStay,
      @NonNull ConstraintLayout constraintLayout2, @NonNull TextView customename,
      @NonNull ImageView imageVieId, @NonNull ImageView imageView14,
      @NonNull ImageView imageViewCancel, @NonNull ImageView imageViewEdit,
      @NonNull ImageView mapIV, @NonNull TextView nameTV, @NonNull TextView phoneNo,
      @NonNull AppCompatImageView profilePic, @NonNull RelativeLayout relative,
      @NonNull TextView textView, @NonNull TextView textViewPaid, @NonNull TextView textViewdate,
  ...
  @NonNull
  public static ItemVenueTodayBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemVenueTodayBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_venue_today, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemVenueTodayBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemVenueTodayBinding((MaterialCardView) rootView, bookedForTV, buttonCheckin,
          buttonStay, constraintLayout2, customename, imageVieId, imageView14, imageViewCancel,
          imageViewEdit, mapIV, nameTV, phoneNo, profilePic, relative, textView, textViewPaid,
          textViewdate, venue);
    }
