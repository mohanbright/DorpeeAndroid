...
public final class ActivityAvailbiltyBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityAvailbiltyBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityAvailbiltyBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAvailbiltyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_availbilty, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAvailbiltyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAvailbiltyBinding((ConstraintLayout) rootView, alertView, backbtn,
