...
public final class ActivityTopUpBinding implements ViewBinding {
  ...
  private ActivityTopUpBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout addConstraint, @NonNull CoordinatorLayout alertView,
      @NonNull TextInputEditText amoutET, @NonNull TextView backbtn,
      @NonNull CardInputWidget cardInputWidget, @NonNull Guideline guideline15,
      @NonNull Guideline guideline16, @NonNull Guideline guideline17,
      @NonNull CircleImageView imageViewProfilePic, @NonNull ContentLoadingProgressBar loginLoader,
      @NonNull RecyclerView recyclerCards, @NonNull TextInputLayout textLayoutfirstName,
      @NonNull TextView textView13, @NonNull TextView textView7, @NonNull TextView tvTotal) {
  ...
  public static ActivityTopUpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTopUpBinding((ConstraintLayout) rootView, addConstraint, alertView,
          amoutET, backbtn, cardInputWidget, guideline15, guideline16, guideline17,
          imageViewProfilePic, loginLoader, recyclerCards, textLayoutfirstName, textView13,
          textView7, tvTotal);
    }
